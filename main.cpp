...
TEST_CASE("test A2DConverter12Bit.convertADCValueToAmpere : value within boundary") {
    ...
    REQUIRE ((actual12BitCurrentValueInAmpere.size() == expectedCurrentValueInAmpere.size()) == true);
    REQUIRE (std::equal(actual12BitCurrentValueInAmpere.begin(), 
...
TEST_CASE("test A2DConverter10Bit.convertADCValueToAmpere : value within boundary")
{
    ...
    REQUIRE ((actual10BitCurrentValueInAmpere.size() == expectedCurrentValueInAmpere.size()) == true);
